    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{route('admin.listpetugas')}}" aria-expanded="false" aria-controls="charts">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Anda dapat mengelola data perpustakaan seperti buku dan peminjam</h6>
                </div>
          ...
          <div class="row">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Chart jumlah buku per Kategori</h4>
                <canvas id="catsChart" class="chartjs" width="undefined" height="undefined"></canvas>
