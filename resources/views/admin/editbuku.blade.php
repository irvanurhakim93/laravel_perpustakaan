                ...
                <div class="card-body">
                  ...
                  <form action="{{route('admin.updatebuku',$data->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="namabuku" name="namabuku" value="{{$data->nama}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Tahun Terbit</label>
                      <input type="text" class="form-control" id="tahunterbit" name="tahunterbit" value="{{$data->tahun_terbit}}" required>
                    </div>
                    <div class="form-group">
