            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{route('admin.uploadbuku')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Buku</label>
                      <input type="text" class="form-control" id="namabuku" name="namabuku" placeholder="Masukkan Nama Buku" required>
                    </div>
                    <div class="form-group">
