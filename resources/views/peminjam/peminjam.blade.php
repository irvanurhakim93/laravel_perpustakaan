...
<head>
  ...
  <title>Halaman Daftar Peminjam</title>
  <!-- plugins:css -->
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{route('peminjam.edit',$peminjam->id)}}" class="btn btn-primary">Ubah</a></td>
                            <td><form action="{{route('peminjam.delete',$peminjam->id)}}" method="post">
                              @csrf
                              @method('DELETE')
