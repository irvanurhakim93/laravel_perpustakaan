        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Edit Peminjam</h4>
                  <form action="{{route('peminjam.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="idbuku" name="idbuku" value="{{$data->id_buku}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">ID Anggota</label>
                      <input type="text" class="form-control" id="idanggota" name="idanggota" value="{{$data->id_anggota}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Tanggal Pinjam</label>
                      <input type="date" class="form-control" id="tglpinjam" name="tglpinjam" value="{{$data->tanggal_pinjam}}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Tanggal Kembali</label>
                        <input type="date" class="form-control" id="tglkembali" name="tglkembali" value="{{$data->tanggal_kembali}}" required>
                      </div>
