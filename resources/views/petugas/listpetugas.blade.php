              ...
              <div class="row">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('admin.tambahanggota')}}" class="btn btn-success">Tambah petugas</a>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{route('admin.editanggota',$petugas->id)}}" class="btn btn-primary">Ubah</a></td>
                            <td><form action="{{route('admin.hapusanggota',$petugas->id)}}" method="post">
                              @csrf
                              @method('DELETE')
