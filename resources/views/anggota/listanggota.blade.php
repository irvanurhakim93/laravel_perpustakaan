              ...
              <div class="row">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('admin.tambahanggota')}}" class="btn btn-success">Tambah anggota</a>
                    <a href="{{route('peminjam.index')}}" class="btn btn-primary">Data Peminjam</a>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{route('admin.editanggota',$anggota->id)}}" class="btn btn-primary">Ubah</a></td>
                            <td><form action="{{route('admin.hapusanggota',$anggota->id)}}" method="post">
                              @csrf
                              @method('DELETE')
