            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{route('admin.updateanggota',$data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Anggota</label>
                      <input type="text" class="form-control" id="namamember" name="namamember" value="{{$data->nama}}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{$data->telepon}}" required>
                      </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Status Aktif</label>
                      <input type="text" class="form-control" id="statusaktif" name="statusaktif" value="{{$data->status_aktif}}" required>
                    </div>
