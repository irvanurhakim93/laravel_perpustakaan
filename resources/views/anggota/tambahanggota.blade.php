  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="" class="mr-2"/>Admin</a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{route('admin.listanggota')}}" aria-expanded="false" aria-controls="form-elements">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{route('admin.uploadanggota')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Anggota</label>
                      <input type="text" class="form-control" id="namamember" name="namamember" placeholder="Masukkan Nama Anggota" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Alamat</label>
                      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan Alamat nggota" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword4">Status Aktif</label>
                      <input type="text" class="form-control" id="statusaktif" name="statusaktif" placeholder="Status Aktif" required>
                    </div>
